...
CAD and programs for a quick and simple handheld force gauge. User interface allows for changing units (N/kg), setting tare (zeroing), recording min/max values, and switching screen orientation. Onscreen values are broadcasted with Bluetooth and a local Python script allows for realtime display and data recording into a csv file. 
...
<br/>
Video demonstration: https://www.youtube.com/watch?v=c7aWqw2UN0I
